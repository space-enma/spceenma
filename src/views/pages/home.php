...
<main>
    ...
    <div class="info-titulo">
        <h1 >Sua Empresa Online</h1>
    </div>  
    <section class="info-siteno-ar">
        <div class="info-seu-site">
            <div class="info-seu-1">

                <img class="info-1-img" src="<?=$base;?>/assets/img/defesa.png" alt="">
            ...
            <div class="info-seu-1">
                <img class="info-1-img" src="<?=$base;?>/assets/img/pesquisa.png" alt="">
            ...
            <div class="info-seu-1">
                <img class="info-1-img" src="<?=$base;?>/assets/img/pagina-da-internet.png" alt="">
        ...
        <div class="equipe-caixa">
                    ...
                    <div class="caixa2">
                        <div class="caixa2-a">
                            <div class="caixa2-a-text">
                                <h1>Leandro Nonato</h1>
                                <p>Ceo e programador</p>
                            </div>   
                        </div>
                    </div> 
            </div>
            ...
            <div class="caixa">
                    ...
                    <div class="caixa2">
                        <div class="caixa2-a">
                            <div class="caixa2-a-text">
                                <h1>Luciano Nonato</h1>
                                <p>Ceo e programador</p>
                            </div>                               
                        </div>
                    </div> 
            </div>
            <div class="caixa caixa-movel">
                    <div class="thumb">
                            <img src="<?=$base;?>/assets/img/pessoa1.jpg" alt="" class="img">      
    ...
    <section class="slaid">
        ...
        <div class="titulo-slaid">
                <p>Estudos de Casos</p>
                <h1>Nossos Projetos Lançados Recentes <br/>
                Disponíveis no Mercado</h1>
        </div>

        <div class="container-carousel" id="carousel-img">
            <div class="carousel-controls">   
                <div class="carousel-control" onclick="goPrev()"><img src="<?=$base;?>/assets/img/setaesquerda.png" alt=""></div>
                <div class="carousel-control" onclick="goNext()"><img src="<?=$base;?>/assets/img/setadireita.png" alt=""></div>
            </div>

            <div class="carousel" >
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo2.jpg" alt=""></div>
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo1.jpg" alt=""></div>
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo3.jpg" alt=""></div>
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo4.jpg" alt=""></div>
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo5.jpg" alt=""></div>
                <div class="carousel-img"><img src="<?=$base;?>/assets/img/projetos/modelo6.jpg" alt=""></div>  
